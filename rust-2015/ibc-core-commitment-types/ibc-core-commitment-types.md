...
- crates.io 页面：https://crates.io/crates/ibc-core-commitment-types
...
- Cargo 安装：`cargo add ibc-core-commitment-types`
- 下载页面：https://crates.io/crates/ibc-core-commitment-types
- 最低 Rust 版本：1.79.0
