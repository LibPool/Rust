...
- crates.io 页面：https://crates.io/crates/http-request
- 源码仓库：https://github.com/crates-dev/http-request.git
...
- Cargo 安装：`cargo add http-request`
- 下载页面：https://crates.io/crates/http-request
