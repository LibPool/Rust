...
- crates.io 页面：https://crates.io/crates/trust-dns-client
- 文档：https://docs.rs/trust-dns
...
- Cargo 安装：`cargo add trust-dns-client`
- 下载页面：https://crates.io/crates/trust-dns-client
- 文档：https://docs.rs/trust-dns
- 最低 Rust 版本：1.64.0
